...
//   return (
//     <div className="bg-green-200 py-10 text-center text-lg">
...
//                     </span>
//                     <div className="ml-4">
//                       <p className="text-lg font-medium">Secure Donations</p>
//                     </div>
//                   </div>
...
//                     </span>
//                     <div className="ml-4">
//                       <p className="text-lg font-medium">Safe & Reliable</p>
//                     </div>
//                   </div>
//                   <span className="ml-6 h-7 flex items-center">
//                     <svg
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <p className="mb-8 text-white text-2xl">
            At GoFundMe, we take the security of your donations very seriously.
            We use industry-leading encryption and security practices to protect
